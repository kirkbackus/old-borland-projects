...
void CameraLookAt(float xf, float yf, float zf, float xt, float yt, float zt, float xup, float yup, float zup) {
  glMatrixMode(GL_PROJECTION);
  glLoadIdentity();

  gluPerspective(45.0f,640.0f/480.0f,2.0f,128.0f);
  gluLookAt(xf,yf,zf,xt,yt,zt,xup,yup,zup);
