// Decompiled by DJ v3.9.9.91 Copyright 2005 Atanas Neshkov  Date: 5/10/2008 2:09:20 PM
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   WorldCupSoccerSlime.java
...
label0:
    ...
    public WorldCupSoccerSlime()
    {
        ...
        slimaryCols = (new Color[] {
            Color.cyan, Color.red, Color.green, darkGreen, Color.white, darkRed, darkRed, new Color(119, 41, 28), Color.yellow, Color.green, 
            Color.white, Color.white, new Color(128, 128, 255), darkBlue, Color.white, Color.red, Color.white, new Color(119, 41, 28), Color.green, Color.white, 
            Color.white, Color.white, new Color(185, 30, 2), Color.white, Color.red, new Color(252, 239, 82), Color.white, Color.red, new Color(16, 180, 180), new Color(241, 245, 71), 
            new Color(230, 230, 230), Color.white
        });
        secondaryCols = (new Color[] {
            Color.white, Color.black, Color.yellow, Color.red, Color.red, darkBlue, Color.white, Color.white, darkBlue, Color.green, 
            Color.blue, darkBlue, Color.white, Color.white, Color.blue, Color.white, Color.red, darkGreen, Color.white, new Color(128, 255, 128), 
            new Color(255, 128, 0), darkGreen, darkBlue, new Color(13, 131, 10), Color.white, Color.blue, Color.red, Color.white, Color.black, new Color(7, 177, 33), 
    ...
    private String slimeColText[] = {
        ...
        "Senegal", "Slovenia", "Spain", "Soth Africa", "South Korea", "Sveden", "Tunisia", "Turkey", "Uruguay", "Brazil", 
        "England", "Germany"
    };
